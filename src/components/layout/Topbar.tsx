            ...
            {roleDropdownOpen && (
              <>
                ...
                <div
                  ...
                  className="absolute right-0 mt-2 w-76 bg-white rounded-2xl shadow-2xl border border-slate-200/80 z-50 p-2 space-y-1 text-xs"
                >
                  <div className="px-3 py-2 border-b border-slate-100">
                    <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">
                      Uwezo Elite School Staff Roles
                    </p>
                    <p className="text-xs text-slate-700 font-medium mt-0.5">
                      Logged in: <strong className="text-emerald-700">{currentUser?.displayName}</strong>
                    </p>
                  </div>
